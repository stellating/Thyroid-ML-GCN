...
class GCNResnet(nn.Module):
    def __init__(self, model, num_classes, in_channel=300, t=0, adj_file=None):
        ...
        # print('[models/GCNResnet-init gen_A]:', num_classes, t, adj_file)
        # print('[models/GCNResnet-init _adj]:',_adj)
    ...
    def forward(self, feature, inp):
        ...
        # print(self.fc)
        x = self.fc(feature)
        # print('[models/forward feature]:',feature)
        # feature = self.pooling(feature)
        # feature = feature.view(feature.size(0), -1)
        #
        #
        # inp = inp[0]
        # # print('[models/forward inp]:',inp)
        # adj = gen_adj(self.A).detach()
        # # print('[models/forward adj]:', adj)
        # x = self.gc1(inp, adj)
        # x = self.relu(x)
        # x = self.gc2(x, adj)
        #
        ...
        # print('[models/forward output]:', x.shape)
        return x
